          ...
          {Object.keys(PRONG_FACTORS).map(prongKey => {
            ...
            return (
              <div key={prongKey} className="space-y-2">
                ...
                {productAnalysis && (
                  <div className="ml-1 mt-1 px-3 py-2 rounded-lg border border-cyan-500/20 bg-cyan-500/5 text-label leading-relaxed text-grey-dark">
                    <span className="font-bold text-[9px] uppercase tracking-wider text-cyan-700 dark:text-cyan-400">
        ...
        <div className="w-full md:w-80 bg-card border border-line rounded-lg p-5 flex flex-col items-center justify-center space-y-6 shrink-0 shadow-sm">
          ...
          {selectedProduct && selectedProduct.howeyScore !== undefined && (
            <div className="w-full rounded-lg border border-cyan-500/20 bg-cyan-500/5 p-3 text-center space-y-1">
              <span className="text-[9px] font-bold uppercase tracking-wider text-cyan-700 dark:text-cyan-400 block">
