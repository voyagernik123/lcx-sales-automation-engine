# THE APP SWEEP — status: **7 of 8 relief surfaces reached, no findings**

<!-- GENERATED by scripts/3d-audit-app.mjs. Do not edit: run `node scripts/3d-audit-app.mjs`. -->

Swept 2026-08-14. **This file is output, not prose** — the same discipline as `docs/3d/e9/README.md` and for the
...
|---|---|---|---|---|---|---|---|
| **E8** | yes | **no listener** | no | **1** | 0 | NONE | 127,925 → 315,170 B |
...
| **E1** | `/command-deck` | 2 | 2 | 1 | 1 | 1 | 3 | n/a — no toggle |
