...
writeFileSync(join(HERE,'live.html'), `<!doctype html><meta charset="utf-8"><title>E0</title>
<style>${css}</style>
...
<canvas id="c" style="width:1280px;height:800px;display:block"></canvas>
<pre id="log" style="color:#7fb2ff;font:12px ui-monospace,monospace;padding:12px 0"></pre>
