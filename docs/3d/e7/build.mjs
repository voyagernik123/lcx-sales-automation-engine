...
// One canvas and one log element, nothing else: the storm IS the frame, and any chrome around it
// would be chrome I then have to reason about when a capture looks wrong.
writeFileSync(join(HERE,'live.html'), `<!doctype html><meta charset="utf-8"><title>E7</title>
<style>${css}</style>
