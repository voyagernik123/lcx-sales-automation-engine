...
const report = {
  ...
  /* Empty means the palette CONSTANTS table is self-consistent: every BRAND_HEX entry survives
     hexToLinear -> linearToHex. It says NOTHING about this frame — the tone map is not on that
     path. What this frame can claim is order preservation; see brandPixel.test.ts. */
