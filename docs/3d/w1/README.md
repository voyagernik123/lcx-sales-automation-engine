...
| L4 cost | `flat/bars.ts` alone: **8.4 KB** (8618 B). The whole gate — spine + bars + this harness, tree-shaken — is **18.3 KB** (18696 B). Generated by `node docs/3d/w1/build.mjs`, which exits non-zero if this row and the bundler disagree |
