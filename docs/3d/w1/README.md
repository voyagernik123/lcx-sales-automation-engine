...
| L4 cost | `flat/bars.ts` alone: **8.4 KB** (8618 B). The whole gate — spine + bars + this harness, tree-shaken — is **18.0 KB** (18446 B). Generated by `node docs/3d/w1/build.mjs`, which exits non-zero if this row and the bundler disagree |
<!-- gl-budget:end w1-bundle -->

<!-- gl-budget:begin spine -->
Layer budget (§6.4): the spine measures **78.4 KB** of the 147 KB its six lanes allocate.
<!-- gl-budget:end spine -->
