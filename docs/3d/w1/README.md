...
| L4 cost | `flat/bars.ts` alone: **8.6 KB** (8789 B). The whole gate — spine + bars + this harness, tree-shaken — is **18.9 KB** (19307 B). Generated by `node docs/3d/w1/build.mjs`, which exits non-zero if this row and the bundler disagree |
