...
| L4 env | ≤ 60 KB raw | **42.6 KB** | ✓ |
| L3.5 particles | ≤ 11 KB raw | **10.9 KB** | ✓ |
| L4.5 field | ≤ 13 KB raw | **9.0 KB** | ✓ |
| **spine total** (all six lanes) | ≤ 147 KB raw | **84.0 KB** | 63.0 KB of the allocation unspent |
| gate bundle — spine + this surface, tree-shaken | — | **24.0 KB** (24575 B) | what this lane actually ships |
| three.js, same job, same settings (P0) | — | 513.3 KB | **6.1× the spine** |
<!-- gl-budget:end lanes -->
