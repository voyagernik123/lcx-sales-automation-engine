...
| P9 PRODUCTION GATE + RELEASE | **WEB LIVE 8e3c0b8 (2026-09-04, both surfaces, probe 1); DESKTOP v0.5.0 IN PROGRESS** — final sweep production-p9 (= P8 to the point), GALLERY with the P0 → P9 block, SCORECARD closed, WALKTHROUGH; CI 33869365348 GREEN on both jobs, first attempt | | | |
