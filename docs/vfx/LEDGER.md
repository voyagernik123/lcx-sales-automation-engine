...
| P9 PRODUCTION GATE + RELEASE | **COMMITTED (this commit; verify-live pending → then LIVE; desktop v0.5.0 follows)** — final sweep production-p9, GALLERY beside the P0 baseline, SCORECARD closed, WALKTHROUGH | | | |
