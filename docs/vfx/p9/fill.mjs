// P5 fill: P8 → P9 aggregates, the desk-route table (with figures = "did content render"), hero panels held, fade hits, redraw.
...
console.log(`  THE SWEEP (docs/instrument/audit/production-p5; 79 routes × 2 themes, fixtures incl. heroes and desk charts, one-page-load pairs,
    ...
    ${line('dark')}
    ${line('light')}
    DESK ROUTES (P8 → P9; "figures" says whether content rendered — with the fixtures the desks are opaque cards over the plate):
${desk}
