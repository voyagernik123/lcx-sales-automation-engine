-- ═══════════════════════════════════════════════════════════════════════════
-- APPLY 0068–0074 · the seven pre-GPS pending migrations, in ledger order.
-- Generated 2026-08-26 from apps/api/src/db/migrations/ at commit 7a0bab9.
-- Byte-for-byte concatenation — nothing edited. Run AFTER (or independently of)
-- APPLY_GPS_0075_0082.sql; the two batches share no dependency.
-- Same contract: one transaction, all-or-nothing, safe to re-run.
-- ═══════════════════════════════════════════════════════════════════════════
...
FROM (VALUES
  ('audit_seal_state'), ('entitlement_events'), ('entitlement_ledger_state'),
  ('marketing_one_mouth_shadow'), ('platform_forecast'), ('platform_forecast_outcome')
